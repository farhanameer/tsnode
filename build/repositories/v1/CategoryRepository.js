    ...
    constructor() {
        this.create = (payload) => __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                Category_1.default.create(payload)
        ...
        this.findById = (id) => __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                Category_1.default.findOne({ _id: id })
        ...
        this.update = (payload) => __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                Category_1.default.updateOne({ _id: payload.categoryId }, _.omit(payload, ["_id"]))
        ...
        this.delete = (payload) => __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                Category_1.default.deleteOne({ _id: payload.categoryId })
                    .then((result) => resolve(result))
                    .catch((e) => reject(e));
            });
        });
